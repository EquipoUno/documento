...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] le indica al sistema que desea acceder a la acci\'on de consulta, seleccionando la opcion "`Consultar del stock"' del men\'u superior \IUref{IUCompra}{Pantalla de Compra}.
